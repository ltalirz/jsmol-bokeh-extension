...
with open('surface3d.coffee', 'r') as f:
    JS_CODE = f.read()
...
surface = Surface3d(
    x="x", y="y", z="z", data_source=source, width=600, height=600)

button = Button(label='zero')


def zero():
    # replace values with zero
    value = 0 * xx
    source.data = dict(x=xx, y=yy, z=value)


button.on_click(zero)
